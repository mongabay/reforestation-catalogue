...
export const COLOR_THEMES: Record<NonNullable<ButtonCommonProps['theme']>, string> = {
  ...
  'secondary-green': `border border-green text-green hover:border-green-dark hover:text-green-dark focus-visible:outline-green`,
  'secondary-white': `border border-white text-white hover:border-grey hover:text-grey focus-visible:outline-white`,
  naked: '',
};
